...
React Native mobile app for **The Wunderkind Factory** — a football club management strategy game. The app handles the core game loop, a dynamic 8-trait Personality Matrix engine, and offline-first sync with a Symfony backend API.
